...
| `cl-content-publishing` | **Full content pipeline** — create content, set metadata, upload video, configure channels, CTA, publish to IG/YT/LinkedIn, poll status. Sub-docs: `content-lifecycle.md`, `channel-configuration.md`, `instagram.md`, `youtube.md`, `linkedin.md`, `platform-rules.md`, `workflows.md` |
| `cl-content-inspiration` | Research trending content — YouTube, Instagram, Twitter, Reddit scraping, tech news, web search. Sub-docs: `youtube-research.md`, `social-scraping.md`, `reddit-research.md`, `news-and-web.md` |
| `cl-remotion/SKILL.md` | Index to all Remotion rules (scene commands, animations, components, patterns, debugging) |
