...
> **Full docs:** load the **`cl-voice`** skill — it covers the live voice bridge
...
> - **Placement guide**: See `cl-content-direction/sfx-placement.md` (skill doc) for the complete SFX placement workflow.
