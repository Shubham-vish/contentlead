...
**Prerequisites:** Load the `cl-editor` skill to understand how to connect to the editor and execute commands. Scenes are added via `POST /api/execute` with scene command types.
