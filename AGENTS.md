...
| **🎙️ Personal content style / remix** | **`content-style`** — extract a user's voice from sample scripts, store profiles in Cosmos, and remix any inspiration into their voice; scores remixes via `virality-scoring` |
