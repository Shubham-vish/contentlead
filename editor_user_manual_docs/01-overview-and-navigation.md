...
1. **Add content** from the left **menu panel** (upload media, add a scene template, add text).
2. **Arrange it** on the **timeline** — order clips, trim them, stack tracks.
3. **Select an item** and fine‑tune it in the **properties panel** (position, size, colors, animation).
4. **Preview** on the canvas until it looks right.
5. **Export** from the top bar to render and download.
...
- [Animations & Keyframes](08-animations-and-keyframes.md)
- [Effects, Filters & Color](09-effects-filters-color.md)
- [Camera Effects](10-camera-effects.md)
- [Audio Mixing & Enhancement](11-audio-mixing-and-enhance.md)
